...
1) За основу берем сборку вебпака [отсюда](https://github.com/jm-program/webpack-static-template). Мануал по использованию сборки - [тут](https://gist.github.com/didolf/b2fcdab713265eee5852221ebf5df7d5). Можно использовать свою
